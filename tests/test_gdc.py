...
HIT_1 = {
    ...
    "file_name": ("c8c7600d-2c13-4df1-b058-2d02432bd49e"
...
HIT_2 = {
    ...
    "file_name": ("20ed86b0-2e3d-44ec-88cd-eac5486fe15c"
                  ".rna_seq.augmented_star_gene_counts.tsv"),
...
MANIFEST_LINE_1 = ("2c73d8ac-84b9-4094-9f5e-fbd6c2e8eabf\t"
                   "c8c7600d-2c13-4df1-b058-2d02432bd49e"
                   ".rna_seq.augmented_star_gene_counts.tsv\t"
                   "4f9639a7ecab8b0dab8db9b17f145a2c\t4216302\treleased")
SHEET_LINE_1 = ("2c73d8ac-84b9-4094-9f5e-fbd6c2e8eabf\t"
                "c8c7600d-2c13-4df1-b058-2d02432bd49e"
                ".rna_seq.augmented_star_gene_counts.tsv\t"
                ...
                "Unknown\tUnknown")
SHEET_LINE_2 = ("7389dfaa-fa36-431f-a3b9-960b4fb9d836\t"
...
class _FakeSession:
    ...
    def post(self, url, json=None, timeout=None):
        ...
        return _FakeResponse({"data": {
            "hits": page,
            "pagination": {"count": len(page), "total": len(hits)},
        }})
...
def test_sample_sheet_golden_rows(tmp_path):
    path = write_gdc_sample_sheet([HIT_1, HIT_2],
                                  tmp_path / "sheet.tsv")
    lines = path.read_text().splitlines()
    assert lines[0] == ("File ID\tFile Name\tData Category\tData Type\t"
...
def test_sample_sheet_dated_name_and_loader_roundtrip(tmp_path):
    ...
    assert {"File ID", "File Name", "Sample ID",
            "Tissue Type"} <= set(sheet.columns)
